...
<head lang="pt-br">
    ...
    <title>ParsiCoin (PARS) Blockchain Explorer</title>
...
<script>
    ...
    (function () {
        ...
        jQuery.timeago.settings.strings = {
            ...
            day: "day",
            days: function (value) {
                return numpf(value, "%d day", "%d day", "%d day");
            },
            month: "month",
            months: function (value) {
                return numpf(value, "%d month", "%d month", "%d month");
            },
            year: "year",
            years: function (value) {
                return numpf(value, "%d year", "%d year", "%d year");
            }
        };
    })();
</script>
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand " href="/"><span id="coinIcon">P</span> <strong>ParsiCoin</strong>PARS</a>
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-left explorer_menu">
                ...
                <li style="display:none;"><a class="hot_link" data-page="blockchain_block.html"
                                             href="#blockchain_block"><i class="fa fa-cubes"></i> Block
                </a></li>

                <li style="display:none;"><a class="hot_link" data-page="blockchain_transaction.html"
                                             href="#blockchain_transaction"><i class="fa fa-cubes"></i> transaction
                </a></li>

                <li style="display:none;"><a class="hot_link" data-page="blockchain_payment_id.html"
                                             href="#blockchain_payment_id"><i class="fa fa-cubes"></i> Transactions by Payment ID
                </a></li>
            ...
            <div class="nav col-md-6 navbar-right explorer-search">
                <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Search by block height / hash, transaction hash, payment id"
                           id="txt_search">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                ...
                <ul>
                    <li><a target="_blank" href="https://parsicoin.net">ParsiCoin.Net</li>
                </ul>
